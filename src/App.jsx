...
function App() {
  return (
    <body class="text-white font-roboto pb-12 bg-body">
      ...
      <div class="container mt-64 flex justify-between items-center mx-auto px-8 md:px-14 lg:px-24 w-full">
        <section class="w-full">
          ...
          <p class="section-paragraph">
            ...
            implementing solutions on both the frontend and backend. To the
            right are several of the frameworks and languages that I have
            experience in. Unfortunately, for some projects, I’m unable to
            pubicly display them, however, feel free to contact me via the
            “Contact Me” section and I can send you a list and potentially
            provide you more details about my other projects I’ve worked on.
          </p>
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
            ...
            <div>
              ...
              <p class="section-paragraph">
                ...
                creation platform that I was a full stack developer for during
                my time at Digital Purpose. The platform enables users to create
                and personalise a wheelchair matching to their needs and then
                send through the design to Rove Wheelchairs for fabrication. It
                was built using AngularJS, THREE.js, and Firebase.
              </p>
              <div class="w-full flex justify-center md:justify-start">
            ...
            <div>
              ...
              <p class="section-paragraph">
                This is the website you're currently looking at! This project
                went live early March, 2022 alongside my move to my new job at
                Deloitte Australia. This project was developed via the
                implementation of ReactJS, Tailwind CSS, and Firebase for
                hosting and email contact functionality.
              </p>
            ...
            <div>
              ...
              <p class="section-paragraph">
                ...
                implementation isn't as impressive as my current one; I
                personally like to keep it here to show my improvement as a
                developer. The project was implemented in ReactJS alongside
            ...
            <div class="w-full border border-nav p-16 lg:px-32 lg:py-20 lg:space-x-32 flex justify-center lg:justify-start flex-wrap lg:flex-nowrap">
              ...
              <div class="flex flex-wrap justify-center text-center lg:text-left lg:block">
                ...
                <div class="w-full lg:w-auto flex flex-wrap justify-center lg:justify-start gap-3 mt-6 mb-8">
                  <div class="badge hover:bg-theme transition-all duration-150 ease-linear">Graduate Consultant</div>
                  <div class="badge hover:bg-theme transition-all duration-150 ease-linear">Platform Engineering</div>
                </div>
                ...
                <p class="text-secondary">
                  ...
                  <br />
                  <br />
                  Worked with clients to enable them to disrupt industries
                  before industries disrupt them. Built and designed business
                  solutions that are powered by modern technology platforms that
                  run on premise, in the cloud, or a hybrid of both.
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="space-y-12 my-16">
            <div class="w-full border border-nav p-16 lg:px-32 lg:py-20 lg:space-x-32 flex justify-center lg:justify-start flex-wrap lg:flex-nowrap">
              ...
              <div class="flex flex-wrap justify-center text-center lg:text-left lg:block">
                ...
                <div class="w-full lg:w-auto flex flex-wrap justify-center lg:justify-start gap-3 mt-6 mb-8">
                  <div class="badge hover:bg-theme transition-all duration-150 ease-linear">Full Stack Developer</div>
                </div>
                ...
                <p class="text-secondary">
                  ...
                  <br />
                  <br />
                  Worked directly with clients and non-technical staff
                  developing tech stacks for web applications. Developed
                  front-end through direct collaboration with the design team
                  and clients. Gained experience over several languages and
                  frameworks, namely AngularJS, THREE.js, and TypeScript.
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="space-y-12 my-16">
            <div class="w-full border border-nav p-16 lg:px-32 lg:py-20 lg:space-x-32 flex justify-center lg:justify-start flex-wrap lg:flex-nowrap">
              ...
              <div class="flex flex-wrap justify-center text-center lg:text-left lg:block">
                ...
                <div class="w-full lg:w-auto flex flex-wrap justify-center lg:justify-start gap-3 mt-6 mb-8">
                  <div class="badge hover:bg-theme transition-all duration-150 ease-linear">Undergraduate Software Engineer</div>
                </div>
      ...
      <div class="container mt-64 flex justify-between items-center mx-auto px-8 md:px-14 lg:px-24 w-full">
        <section class="w-full">
          <h2 id="contact" class="secondary-title">
            Contact Me
          </h2>
          <p class="section-paragraph">
            Feel free to get in touch with me! Either fill out and submit the
            form below, or you can reach me through any of the alternative
            methods provided.
          </p>
          ...
          <div class="w-full grid lg:grid-cols-2 gap-8 lg:gap-32 mt-20">
            <div class="space-y-8">
              ...
              <div>
                ...
                <input
                  type="email"
                  class="w-full border border-input-border bg-input px-4 rounded-sm"
                />
              </div>
              <div>
                <label class="text-white block mb-2 text-xl font-bold">
          ...
          <div class="mt-12">
            <div class="flex my-12 space-x-6">
              {/* GitHub */}
              <a href="https://github.com/jamestkelly" class="hover:text-selected-text transition-all duration-150 ease-linear">
                <BsGithub size="30" />
              </a>

              {/* LinkedIn */}
              <a href="https://www.linkedin.com/in/jimkellyt/" class="hover:text-selected-text transition-all duration-150 ease-linear">
                <BsLinkedin size="30" />
              </a>

              {/* Medium */}
              <a href="https://medium.com/@jimkelly-t" class="hover:text-selected-text transition-all duration-150 ease-linear">
                <BsMedium size="30" />
              </a>
            </div>
          </div>
